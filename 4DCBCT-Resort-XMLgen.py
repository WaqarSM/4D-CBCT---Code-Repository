...
hisFileLoc= '/Users/mwaqar/4DCBCT_Project/img_1.3.46.423632.1354522017101323933437.72/' #Location of the directories that contains the original *.HIS files - DOES need to be changed
sortFileLoc = hisFileLoc+'Reconstruction/1.3.46.423632.1354522017101323933437.72.10.13.2017191452671.SCAN.Sort.txt' #Location of the *Sort.txt file - does not need to be changed
